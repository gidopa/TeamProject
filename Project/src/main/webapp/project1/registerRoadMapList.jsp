...
<body>
	...
	<div class="lecture-container">
		<form id="lectureForm" action="${contextPath}/RoadMap/postRoadMap" method="post">
			<table class="lecture-table">
				<br>
				<br>
				<h1 align="center">로드맵에 추가할 강의를 선택해 주세요.</h1>
				...
				<tbody>
					<c:forEach var="arrayList" items="${requestScope.arrayList}">
						<tr>
							<td><input type="checkbox" name="course_id" value="${arrayList.courseId}"></td> <!-- 각 행에 체크박스 추가 -->
			...
			<br>
				<div class="form-group text-center">
					<button type="submit">선택한 강의 등록</button>
